...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); //отправляет данные, которые получил из формы
...
var modals = function modals() {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); //запускает модальное окно после 6 сек
